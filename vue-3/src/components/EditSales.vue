<template>
    <div>
        <h3 class="text-center">Edit Sales Order</h3>
        <div class="row">
            <div class="col-md-6">
...
<script>
    ...
    export default {        
        ...
        created() {
            ...
            axios
                .get(`http://localhost:8000/api/sales_orders/${this.$route.params.id}`, { headers: authHeader() })
                .then((res) => {
                    console.log(res.data)
        ...
        methods: {            
            updateSalesOrder() {
                ...
                axios
                    .patch(`http://localhost:8000/api/sales_orders/${this.$route.params.id}`, this.sales_order, { headers: authHeader() })
                    .then(response => (
